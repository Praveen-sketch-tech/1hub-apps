...
export const APP_REGISTRY: AppDefinition[] = [
  ...
  },
 {
  ...
  },
  {
    ...
    number: "001",
    name: "Image Tools",
    description: "Compress, resize, convert and prepare government photo/signature specs — all in your browser. No upload, no server, no waiting.",
    path: "/apps/image-tools",
    tags: ["Image Compressor", "Image Resizer", "Format Converter", "Passport Photo", "PAN Card", "Govt Forms"],
    visibility: "public",
    category: "Image Tools",
    seoTitle: "Image Tools — Compress, Resize, Convert & Govt Photo Resizer (Free)",
    seoDescription: "Free browser-based image tools: compress to any quality, resize by percent or pixels, convert JPG/PNG/WEBP, and prepare passport/PAN/Aadhaar/SSC/UPSC photos to exact size and KB. No upload, no signup.",
    keywords: ["image compressor", "image resizer", "jpg to png", "passport photo resizer", "signature resizer", "photo size KB", "PAN card photo size"],
  },
   {
    id: "pdf-compressor",
    number: "002",
