  ...
  },
 {
  ...
  },
  {
  ...
  },
   {
    ...
    number: "002",
    name: "PDF Tools",
    description: "Compress, unlock, protect and create PDFs — including a Hindi + English text editor. All in your browser, no upload, no server.",
    path: "/apps/pdf-tools",
    tags: ["PDF Compressor", "Unlock PDF", "Protect PDF", "Create PDF", "PDF Password"],
    visibility: "public",
    category: "PDF Tools",
    seoTitle: "PDF Tools — Compress, Unlock, Protect & Create PDFs (Free)",
    seoDescription: "Free browser-based PDF tools: compress to WhatsApp-friendly sizes, remove or add a password, and create new PDFs with a Hindi + English rich text editor. No upload, no signup.",
    keywords: ["pdf compressor", "unlock pdf", "protect pdf", "pdf password remover", "create pdf online", "hindi pdf maker"],
  },
  {
    id: 'invoice-maker',
    number: '003',
